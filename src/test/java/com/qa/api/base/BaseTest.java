...
public class BaseTest {
	...
	protected static final String BASE_URL_GO_REST = "https://gorest.co.in";
	protected static final String BASE_URL_CONTACTS = "https://thinking-tester-contact-list.herokuapp.com";
	protected static final String BASE_URL_CIRCUIT = "http://ergast.com";
	protected static final String BASE_URL_BASIC_AUTH = "https://the-internet.herokuapp.com";
	protected static final String BASE_URL_AMAEDUS = "https://test.api.amadeus.com";
	...
	protected static final String REQ_RES_ALL_USERS_ENDPOINT = "/api/users?page=2";
	...
	protected static final String BASIC_AUTH = "/basic_auth";
